...
e_nu_sperr = np.array([200, 275, 380, 525, 675.0, 724, 1000, 1379, 1903, 2626, 3623,
                      5000])
e_UA_sperr = np.array([395.0, 383.3, 350.4, 237.1, 35.4, 84.3, 304.6, 370.0, 391.6,
                       400.6, 405.5, 408.6]) * 1e-3
